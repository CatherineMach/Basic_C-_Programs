    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (answer == "Yes" || answer == "yeah" || answer == "y" || answer == "ya")
            {
                ...
                using (StreamWriter file = new StreamWriter(@"C:\Users\flowe\source\log.txt", true))
                {
        ...
        private string void UpdateDbWithException(Exception ex)
        {
        ...
        private static List<Exception> ReadExceptions()
        {
            string connectionString = @"Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=TwentyOneGame;
                                        Integrated Security=True;Connect Timeout=30;Encrypt=False;
                                        Trust Server Certificate=False;Application Intent=ReadWrite;
